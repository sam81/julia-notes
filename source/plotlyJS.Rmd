...
*Note: The figures shown in the html version of this document will not have interactive features because they've been saved as png files.*
...
savefig(p, "../Figures/plotly_line_plot.png", width=4, height=4)
```
...
savefig(p, "../Figures/plotly_scatter_plot.png", width=4, height=4)
```
...
p = plot([s1], ly);
savefig(p, "../Figures/plotly_line_plot2.png", width=4, height=4)
```
...
p = plot([s1,s2], ly);
savefig(p, "../Figures/plotly_line_plot_2_traces.png", width=4, height=4)
```
