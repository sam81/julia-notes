...
```{julia, results="hide", echo=FALSE}
savefig(p, "../Figures/plotly_line_plot.png", width=size1cplotlypng, height=size1cplotlypng)
...
```{julia, results="hide", echo=FALSE}
savefig(p, "../Figures/plotly_scatter_plot.png", width=size1cplotlypng, height=size1cplotlypng)
...
```{julia, results="hide", echo=FALSE}
savefig(p, "../Figures/plotly_line_plot2.png", width=size1cplotlypng, height=size1cplotlypng)
...
```{julia, results="hide", echo=FALSE}
savefig(p, "../Figures/plotly_line_plot_2_traces.png", width=size1cplotlypng, height=size1cplotlypng)
